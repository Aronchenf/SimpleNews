...
import com.news.simple_news.databinding.FragmentNewsdetailBinding
...
class NewsDetailFragment : BaseFragment<FragmentNewsdetailBinding>() {
    ...
    override fun initLayout(): Int = R.layout.fragment_newsdetail
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        webLink = arguments?.let { MainFragmentArgs.fromBundle(it).webLink }
...
//        webLink=intent.getStringExtra(URL)
    ...
    private fun initWebView() {
        agentWeb = AgentWeb.with(this)
            ...
            .useDefaultIndicator(ContextCompat.getColor(requireActivity(), R.color.dim_gray), 2)
            .interceptUnkownUrl()
